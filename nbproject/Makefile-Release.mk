...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/localdnsserver.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/localdnsserver.exe: ${OBJECTFILES}
...
${OBJECTDIR}/DatagramSocket.o: DatagramSocket.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DatagramSocket.o DatagramSocket.cpp

${OBJECTDIR}/EntryFilter.o: EntryFilter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EntryFilter.o EntryFilter.cpp

${OBJECTDIR}/ExString.o: ExString.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExString.o ExString.cpp

${OBJECTDIR}/INetAddress.o: INetAddress.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/INetAddress.o INetAddress.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/localdnsserver.exe
